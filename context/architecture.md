...
| AI model                       | Gemini 2.5 Flash         | Matching, research synthesis, extraction         |
...
├── agent/
│   ├── adzuna.ts                          → Adzuna API job discovery + Gemini 2.5 Flash scoring
│   ├── research.ts                        → Company research — Browserbase + Stagehand + Gemini 2.5 Flash
│   ├── matcher.ts                         → Gemini 2.5 Flash job matching logic
